...
public class TrajectoryPlanner {
    ...
    //alterado para public static
    public static ArrayList<Point> _trajectory;
     ...
     * requested point @return y-coordinate (on screen) of the requested point
     */
     ...
     * coordinates of the target to hit @return A list containing 2 possible
     * release points
     */
     ...
     * clicked was released from tapPoint - point the tap should be made @return
     * tap time (relative to the release time) in milli-seconds
     */
     ...
     * from @return the canvas with trajectory drawn
     */
     ...
     * in radians (anticlockwise from positive direction of the x-axis) @return
    ...
    //adicionado para tap yellow bird
